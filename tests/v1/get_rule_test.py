...
from samples.v1 import get_rule
...
class GetRuleTest(unittest.TestCase):
  ...
  def test_rule_id_sanity_check(self, mock_session):
    with self.assertRaises(ValueError):
      get_rule.get_rule(mock_session, "invalid-rule-id")
  ...
  def test_happy_path(self, mock_response, mock_session):
    ...
    rule_content = get_rule.get_rule(mock_session,
                                     "ru_12345678-1234-1234-1234-1234567890ab")
    self.assertEqual(rule_content, expected_rule_content)
