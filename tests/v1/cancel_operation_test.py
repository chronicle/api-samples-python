...
#
"""Unit tests for the "cancel_operation" module."""
...
class CancelOperationTest(unittest.TestCase):

  @mock.patch.object(requests, "AuthorizedSession", autospec=True)
  def test_operation_id_sanity_check(self, mock_session):
    with self.assertRaises(ValueError):
      cancel_operation.cancel_operation(mock_session, "invalid-operation-id")
