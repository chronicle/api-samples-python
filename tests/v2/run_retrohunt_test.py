...
from samples.v2 import run_retrohunt
...
class RunRetrohuntTest(unittest.TestCase):
  ...
  def test_happy_path(self, mock_response, mock_session):
    ...
    expected_rh = {
        "retrohundId": "oh_aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa",
        "ruleId": "ru_bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb",
        "versionId": "ru_bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb",
        "eventStartTime": "2021-01-01T00:00:00Z",
        "eventEndTime": "2021-01-02T00:00:00Z",
        "retrohuntStartTime": "2020-01-01T00:00:00Z",
        "retrohuntEndTime": "2020-01-02T00:00:00Z",
        "state": "RUNNING",
